...
class SimulationRequest(BaseModel):
    ...
    min_vol_regime: Optional[float] = Field(default=None, ge=0.0, le=5.0, description="Minimum ATR ratio (current ATR / 14-period ATR MA) to allow entry. e.g., 0.7 = skip low-volatility periods. null = no filter")
