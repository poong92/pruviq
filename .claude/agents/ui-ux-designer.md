...
--color-text: #ffffff        /* 메인 텍스트 */
--color-text-secondary: #999 /* 보조 텍스트 */
--color-accent: #3b82f6      /* 강조색 (파란색) */
--color-accent-hover: #60a5fa
--color-border: #222222      /* 테두리 */
--color-green: #22c55e       /* 수익/긍정 */
--color-red: #ef4444         /* 손실/부정 */
```

**절대 규칙**: 하드코딩 색상값 사용 금지. `bg-[#111]` 대신 `bg-[var(--color-bg-card)]` 사용.
