...
export const ko: Record<TranslationKey, string> = {
  ...
  "problem.card1_desc":
    "569개 이상의 코인에서 88개 전략 조합을 테스트했습니다. 2년 이상의 데이터에서 살아남은 건 단 1개. 선행 편향, 과적합, 레짐 무시 — 대부분의 전략이 같은 이유로 실패합니다.",
  "problem.card1_source": "출처: PRUVIQ 검증 파이프라인, 2024-2026",
  "problem.card2_title": "4개 전략 제거",
  "problem.card2_desc":
    "569개 이상의 코인, 2년 이상 데이터로 5개 전략을 테스트했습니다. 1개만 살아남았습니다. 나머지 4개는 손실을 기록했습니다. 대부분의 플랫폼은 실패를 보여주지 않습니다.",
  ...
  "home.social_proof_cta":
    "이미 1,200명 이상의 트레이더가 PRUVIQ를 사용 중입니다 — 가입 없이 무료로 시작하세요.",
