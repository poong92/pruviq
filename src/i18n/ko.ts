...
export const ko: Record<TranslationKey, string> = {
  ...
  "evidence.step1_desc":
    "모든 전략은 {coins}개 이상의 코인, 2년 이상의 데이터로 테스트한 후에만 실제 자본을 투입합니다. 예외 없음.",
  ...
  "how.step3": "검증",
  "how.step3_desc": "{coins}+ 코인, 2년+ 데이터. 수 초 만에 결과 확인.",
  ...
  "strategies.presets_desc":
    "아래 전략을 클릭하면 시뮬레이터에서 바로 파라미터가 적용됩니다. {coins}개 코인 동시 테스트.",
  ...
  "demo.hero_desc":
    "아래 손절/익절 슬라이더를 조정하여 전략 성과가 어떻게 변하는지 확인하세요. {coins}개+ 코인에 대한 실제 백테스트 결과이며, 수수료가 포함되어 있습니다.",
  ...
  "about.philosophy3_desc":
    "모든 전략은 {coins}개 이상의 코인에서 2년 이상의 데이터로 백테스트한 후 공개합니다. 근거 없이 권하지 않습니다.",
  ...
  "perf.desc":
    "BB Squeeze SHORT 전략 백테스트 결과. {coins}개 코인, 2년 이상 과거 데이터. 체리피킹 없음.",
  "perf.loading": "백테스트 성과 데이터 로딩 중...",
  "perf.stat1_label": "전략",
  "perf.stat1_val": "BB Squeeze SHORT",
  "perf.stat2_label": "코인",
  "perf.stat2_val": "{coins}개",
  ...
  "blog.cta_desc":
    "{coins}개 코인, 2년 이상의 데이터로 트레이딩 전략을 시뮬레이션하세요. 무료.",
  ...
  "learn.cta_desc":
    "전략을 만들고 {coins}개 이상의 코인에서 실행하세요 — 무료, 계정 불필요.",
  ...
  "simulate.title2": "{coins}개 코인에서 테스트하세요.",
  "simulate.desc":
  ...
  "simulate.step3_title": "{coins}개+ 코인에서 백테스트 실행",
  ...
  "methodology.cta_desc":
    "파라미터를 조정하고 {coins}개+ 코인에 대한 실제 백테스트 결과를 확인하세요.",
  ...
  "meta.signals_desc":
    "{strategies}개 검증된 전략이 30개 코인을 매시간 스캔합니다. 실시간 시그널 확인 후 시뮬레이터에서 직접 검증하세요.",
  "signals.title": "실시간 시그널",
  "signals.desc":
    '{strategies}개 전략이 30개 코인을 매시간 스캔합니다. 각 시그널에 진입가, 손절, 익절 수준이 표시됩니다. "Verify"를 클릭하면 시뮬레이터에서 직접 백테스트할 수 있습니다.',
  "signals.stat_strategies": "전략 수",
  "signals.stat_coins": "스캔 코인",
  "signals.stat_interval": "스캔 주기",
  "signals.how_title": "작동 방식:",
  "signals.how_desc":
    "엔진이 최신 완성 1시간 캔들에서 {strategies}개 전략의 진입 조건을 확인합니다. 조건이 충족되면 시그널이 여기에 표시됩니다. 시그널은 매매 추천이 아닙니다 — 항상 시뮬레이터에서 먼저 검증하세요.",
  ...
  "compare_index.strength2_tag": "{coins}개 코인 동시 테스트",
  "compare_index.strength2_title": "전체 시장을 한 번에",
  "compare_index.strength2_desc":
    "다른 플랫폼은 코인 하나씩 테스트합니다. PRUVIQ는 {coins}개 코인을 한 번에 스캔 — 진짜 작동하는 전략을 찾으세요.",
  ...
  "vs.row_coins": "크립토 코인",
  "vs.row_coins_p": "{coins}개+ USDT 무기한 선물",
  ...
  "vs.row_multi_p": "{coins}개 코인 원클릭 테스트",
  ...
  "vs.when_pruviq_2": "{coins}개+ 코인에서 동시 전략 테스트",
  ...
  "faq.a1":
    "PRUVIQ는 무료 크립토 전략 백테스팅 플랫폼입니다. 14개 기술 지표를 사용해 커스텀 전략을 만들고, {coins}개 이상의 코인에서 2년 이상의 실제 시장 데이터로 백테스트하며, 수수료와 슬리피지를 포함한 현실적인 결과를 확인할 수 있습니다. 코딩 불필요.",
  ...
  "faq.a3":
    "네, PRUVIQ의 핵심 백테스팅 기능은 완전 무료입니다. 전략 만들기, {coins}개 이상 코인 백테스트, 모든 교육 콘텐츠 이용이 결제나 계정 생성 없이 가능합니다.",
  "faq.q4": "PRUVIQ가 TradingView 등 다른 도구와 다른 점은?",
  "faq.a4":
    "PRUVIQ는 코딩 없이 크립토 선물에 특화되어 설계되었습니다. TradingView(Pine Script 필요)나 QuantConnect(Python/C# 필요)와 달리 시각적 전략 빌더를 제공합니다. 또한 실패를 포함한 실제 거래 결과를 공개하고, {coins}개 이상 코인을 동시에 테스트하며, 모든 시뮬레이션에 현실적인 수수료와 슬리피지를 포함합니다.",
  "faq.q5": "PRUVIQ는 전략을 어떻게 검증하나요?",
  "faq.a5":
    "PRUVIQ는 {coins}개 이상의 코인에서 2년 이상의 과거 데이터로 모든 전략을 백테스트합니다. 수수료, 슬리피지, 펀딩비를 포함한 현실적인 시뮬레이션으로 검증하며, 실패한 전략도 모두 공개합니다.",
  ...
  "leaderboard.desc":
    "{coins}개 이상의 코인에서 이번 주 가장 좋은 성과를 보인 전략 설정을 확인하세요. 매주 월요일 업데이트.",
  ...
  "coin_detail.strategy_desc":
    "BB Squeeze 전략은 {name}에서 저변동성 구간(볼린저밴드 압축)을 식별합니다. 밴드가 확장되고 가격이 하향 돌파하면 숏 포지션에 진입합니다. {coins}개 코인에서 Out-of-Sample 테스트와 몬테카를로 시뮬레이션으로 검증되었습니다.",
  ...
  "simulate.preset_verified_tooltip":
    "검증됨 = {coins}개+ 코인, 2년+ 실제 시장 데이터 백테스트",
  ...
  "compare.row3_pruviq": "{coins}개+ 코인 동시 테스트",
  ...
  "vs_3commas.tldr_text":
    "3Commas는 실거래 자동화($15-110/월). PRUVIQ는 거래 전 전략 검증 — 무료, 코딩 불필요, {coins}개 코인, 실제 수수료·슬리피지 반영. PRUVIQ로 연구하고 3Commas로 실행하세요.",
  ...
  "vs_3commas.row_coins_p": "{coins}개 코인 (바이낸스 USDT 선물)",
  ...
  "vs_3commas.row_multi_p": "{coins}개 코인 한 번에 테스트",
  ...
  "vs_3commas.why_1_desc":
    "하락 추세 코인에 DCA 봇을 돌리면 설정과 무관하게 손실이 납니다. PRUVIQ로 {coins}개 코인에서 실제 수수료를 반영해 가설을 먼저 검증하세요.",
  "vs_3commas.why_2_title": "실패도 공개합니다",
  "vs_3commas.why_2_desc":
    "PRUVIQ는 성공한 전략과 함께 실패한 전략도 공개합니다. {coins}개 코인 중 400개에서 실패한 전략을 보는 것이 선별된 성공 사례보다 가치 있습니다.",
  ...
  "vs_3commas.when_pruviq_2":
    "하나의 전략을 {coins}개 코인에 한 번에 테스트할 때",
  ...
  "vs_coinrule.tldr_text":
    "Coinrule은 규칙 기반 자동화 도구입니다. PRUVIQ는 백테스팅 우선 연구 도구 — 무료, 코딩 불필요, {coins}개 코인, 슬리피지·수수료 내장.",
  ...
  "vs_coinrule.row_multi_p": "{coins}개 코인 동시 테스트",
  ...
  "vs_coinrule.cta_desc":
    "어떤 자동화 도구에 비용을 지불하기 전에 {coins}개 코인으로 전략을 백테스트하세요. 회원가입 불필요.",
  ...
  "vs_cryptohopper.tldr_text":
    "Cryptohopper는 클라우드 봇으로 실거래 실행($24-107/월). PRUVIQ는 거래 전 전략 검증 — 무료, 코딩 불필요, {coins}개 코인, 실제 수수료·슬리피지 모델링. 연구 먼저, 자동화는 나중에.",
  ...
  "vs_cryptohopper.row_coins_p": "{coins}개 코인 (바이낸스 USDT 선물)",
  ...
  "vs_cryptohopper.row_multi_p": "{coins}개 코인 한 번에 테스트",
  ...
  "vs_cryptohopper.why_1_desc":
    "월 $24-107의 Cryptohopper는 투자입니다. PRUVIQ로 {coins}개 코인에서 전략 아이디어를 무료로 검증한 뒤 구독을 결정하세요.",
  ...
  "vs_cryptohopper.when_pruviq_2":
    "마켓플레이스 전략 아이디어를 {coins}개 코인에서 검증하고 싶을 때",
  ...
  "vs_gainium.tldr_text":
    "Gainium은 DCA 실행과 포트폴리오 관리에 집중합니다. PRUVIQ는 연구 우선 백테스팅 도구 — 무료, 코딩 불필요, {coins}개 코인, 실제 비용 시뮬레이션.",
  ...
  "vs_gainium.row_multi_p": "{coins}개 코인 동시 테스트",
  ...
  "vs_streak.row_multi_p": "{coins}개 코인 동시 테스트",
  ...
  "vs_streak.cta_desc":
    "Pine Script도, TradingView 계정도, 구독료도 필요 없습니다. {coins}개 코인으로 실제 결과를 몇 초 만에 확인하세요.",
  ...
  "simV2.hero.cta_expert": "직접 만들기",
  "simV2.skill.label": "모드",
  "simV2.skill.quick": "퀵 스타트",
  "simV2.skill.standard": "스탠다드",
  "simV2.skill.expert": "엑스퍼트 빌더",
  "simV2.skill.quick_summary": "프리셋 선택만으로 결과 확인. 설정 불필요.",
  "simV2.skill.standard_summary": "리스크·기간·코인 조정 가능.",
  "simV2.skill.expert_summary": "전체 조건 빌더 — 지표·로직 직접 구성.",
  "simV2.presets.heading": "큐레이션 프리셋",
  "simV2.presets.sub": "프리셋 클릭 시 빌더에 자동 로드됩니다.",
  "simV2.presets.verified": "검증 완료",
  "simV2.presets.verified_tooltip": "아웃오브샘플 + 워크포워드 검증 통과 전략.",
  "simV2.risk.low": "저위험",
  "simV2.risk.medium": "중위험",
  "simV2.risk.high": "고위험",
  "simV2.direction.long": "롱",
  "simV2.direction.short": "숏",
  "simV2.direction.both": "롱/숏",
  "simV2.defaults.sl_label": "손절",
  "simV2.defaults.tp_label": "익절",
  "simV2.trust.gap_heading": "백테스트 vs 실 OKX",
  "simV2.trust.gap_backtest": "백테스트",
  ...
  "simV2.cta.connect_button": "OKX 연결",
  "simV2.cta.learn_more": "동작 방식",
