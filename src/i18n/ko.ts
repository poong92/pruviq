...
export const ko: Record<TranslationKey, string> = {
  ...
  'about.team_tag': '제작자',
  'about.team_desc': 'PRUVIQ는 독립 개발자가 만든 프로젝트입니다. 직감이 아닌 코드로 트레이딩합니다. 모든 검증된 전략은 먼저 본인의 실제 자금으로 운영합니다 — 남에게 권하기 전에 제 돈을 먼저 겁니다.',
  'about.builder_name': '제작: 이재풍',
  'about.builder_bio': '한국 기반 퀀트 트레이더 겸 개발자. 투명하고 데이터 기반의 크립토 트레이딩 도구를 만듭니다.',
