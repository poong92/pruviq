...
export const ko: Record<TranslationKey, string> = {
  ...
  "fees.trust_tag": "레퍼럴의 진실",
  "fees.trust_title": "20% 할인 광고. 실제 받는 건 0%일 수 있습니다.",
  "fees.trust_desc":
    "바이낸스는 추천인이 사용자 할인을 0%로 설정하고 전부 가져가는 것을 공식적으로 허용합니다. 버그가 아니라 정책입니다. 대부분의 사용자는 확인조차 하지 않고 — 가입 후에는 레퍼럴 코드를 변경할 수 없습니다. 영원히.",
  "fees.trust_col_user": "사용자 할인",
  "fees.trust_col_platform": "추천인 수취",
  "fees.trust_typical": "'20% 할인' 광고의 실체",
  "fees.trust_influencer": "최악의 경우 (공식 허용)",
  "fees.trust_point1_title": "다른 곳은 0%를 줄 수 있습니다",
  "fees.trust_point1_desc":
    "바이낸스는 공식적으로 추천인이 커미션 100%를 가져가도록 허용합니다. 광고에서 '20% 할인'을 보고 가입했는데, 실제로 0%. 알림도 없습니다.",
  "fees.trust_point2_title": "PRUVIQ는 1%만 가져갑니다",
  "fees.trust_point2_desc":
    "현물: 당신 19%, 우리 1%. 선물: 당신 9%, 우리 1%. 직접 확인하세요 — 바이낸스 계정 → 수수료 일정.",
  "fees.trust_point3_title": "가입 후 변경 불가",
  "fees.trust_point3_desc":
    "바이낸스는 가입 시 레퍼럴 코드를 영구 고정합니다. 0%를 주는 곳으로 가입했다면 되돌릴 방법이 없습니다. 가입 전에 신중하게 선택하세요.",
