export const en = {
  ...
  'about.team_tag': 'THE BUILDER',
  'about.team_desc': 'PRUVIQ is an independent project built by a solo developer who trades with code, not gut feeling. Every verified strategy runs on real capital first — I risk my own money before suggesting you risk yours.',
  'about.builder_name': 'Built by JP Lee',
  'about.builder_bio': 'Quantitative trader and developer based in Korea. Building transparent, data-driven tools for crypto traders.',
