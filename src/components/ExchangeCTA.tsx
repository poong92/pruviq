      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {available.map(ex => (
          ...
          >
            ...
            <span class="px-3 py-1.5 rounded-md bg-[--color-accent] text-[--color-bg] text-xs font-semibold group-hover:bg-[--color-accent-dim] transition-colors whitespace-nowrap">
              {t.signup} &rarr;
            </span>
          </a>
        ))}
