...
const STRATEGIES: SearchItem[] = [
  {
    ...
    href: "/simulate/builder/?preset=bb-squeeze-short",
    category: "strategy",
  },
  {
    label: "BB Squeeze LONG",
    description: "Volatility squeeze ↑",
    href: "/simulate/builder/?preset=bb-squeeze-long",
    category: "strategy",
  },
  {
    label: "RSI Reversal LONG",
    description: "Oversold bounce ↑",
    href: "/simulate/builder/?preset=rsi-reversal-long",
    category: "strategy",
  },
  {
    label: "MACD Momentum LONG",
    description: "Momentum surge ↑",
    href: "/simulate/builder/?preset=macd-momentum-long",
    category: "strategy",
  },
  {
    label: "EMA Crossover LONG",
    description: "Trend cross ↑",
    href: "/simulate/builder/?preset=ema-crossover-long",
    category: "strategy",
  },
  {
    label: "ADX Trend SHORT",
    description: "Strong trend ↓",
    href: "/simulate/builder/?preset=adx-trend-short",
    category: "strategy",
  },
  {
    label: "Ichimoku Cloud LONG",
    description: "Cloud bullish ↑",
    href: "/simulate/builder/?preset=ichimoku-cloud-long",
    category: "strategy",
  },
  {
    label: "Turtle Breakout LONG",
    description: "Breakout ↑",
    href: "/simulate/builder/?preset=turtle-breakout-long",
    category: "strategy",
  },
  {
    label: "ADX Trend LONG",
    description: "Trend following ↑",
    href: "/simulate/builder/?preset=adx-trend-long",
    category: "strategy",
  },
  {
    label: "MACD Crossover SHORT",
    description: "MACD cross ↓",
    href: "/simulate/builder/?preset=macd-crossover-short",
    category: "strategy",
  },
];
